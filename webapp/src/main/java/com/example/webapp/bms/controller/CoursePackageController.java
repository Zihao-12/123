...
public class CoursePackageController {
    ...
    public Result add(@RequestBody CoursePackageDO meCoursePackageDO){
        Result result;
        try {
            result = (Result) coursePackageService.insert(meCoursePackageDO);
        } catch (Exception e) {
            log.error("{}",ExceptionUtils.getStackTrace(e));
    ...
    public Result view(@PathVariable Integer id){
        try {
             return (Result) coursePackageService.view(id);
        } catch (Exception e) {
           log.error("{}",ExceptionUtils.getStackTrace(e));
        }
        return Result.fail();
    ...
    public Result update(@RequestBody CoursePackageDO meCoursePackageDO){
        try {
            return (Result) coursePackageService.update(meCoursePackageDO);
        } catch (Exception e) {
            log.error("{}",ExceptionUtils.getStackTrace(e));
        }
        return Result.fail();
    ...
    public Result delete(@PathVariable Integer id){
        try {
            return (Result) coursePackageService.delete(id);
        } catch (Exception e) {
            log.error("{}",ExceptionUtils.getStackTrace(e));
        }
        return Result.fail();
    ...
    public Result disassociate(@PathVariable Integer packageId,@PathVariable Integer courseId){
        try {
            return (Result) coursePackageService.disassociate(packageId,courseId);
        } catch (Exception e) {
            log.error("{}",ExceptionUtils.getStackTrace(e));
        }
        return Result.fail();
    ...
    public Result updateSale(@PathVariable Integer id, @PathVariable Integer status) {
        Result result = (Result) coursePackageService.updateSale(id, status);
        return result;
    }

    @PostMapping(value = "/set-trial-type/{id}/{status}")
    public Result setTrialType(@PathVariable Integer id, @PathVariable Integer status) {
        Result result = (Result) coursePackageService.updateTrySale(id, status);
        return result;
    }
    ...
    public Result copyPackage(@PathVariable Integer id) {
        try {
            return (Result) coursePackageService.copyPackage(id);
        } catch (Exception e) {
           log.error(ExceptionUtils.getStackTrace(e));
        }
        return Result.fail();
